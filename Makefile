...
SCR_PARSING := tokens.c tokens2.c parsing.c envp.c envp_lst.c tokens_lst.c dollar.c dollar2.c replace_list.c identification.c prepare.c tilde.c rm_quotes.c syntax_error.c signal.c
