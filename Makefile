...
#    Updated: 2023/08/11 17:00:51 by croy             ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
SRC_EXEC_UTILS := split_paths.c utils_close.c utils_env.c utils_env2.c utils_execve.c utils_files.c utils_files2.c utils_free.c utils_heredoc.c utils_init.c utils_path.c utils_redirections.c utils_subshell.c utils.c
